			...
			'emails'   => [
				'fields' => [
					'email_listing_claim_approve' => [
						...
						'type'        => 'textarea',
						'default'     => hp\sanitize_html( __( 'Hi, %user_name%! Your claim for "%listing_title%" has been approved, click on the following link to edit it: %listing_url%', 'hivepress-claim-listings' ) ),
						'html'        => 'post',
						'required'    => true,
						'autoload'    => false,
						'order'       => 40,
					...
					'email_listing_claim_reject'  => [
						...
						'type'        => 'textarea',
						'default'     => hp\sanitize_html( __( 'Hi, %user_name%! Unfortunately, your claim for "%listing_title%" has been rejected.', 'hivepress-claim-listings' ) ),
						'html'        => 'post',
						'required'    => true,
						'autoload'    => false,
						'order'       => 50,
